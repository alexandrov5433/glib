...
enum GalxlibError free_regex_container(RegexContainer **container)
{
        if (NULL == container)
...
enum GalxlibError new_regex_container(
    ...
    RegexContainer **const output)
{
        ...
        enum GalxlibError rv = GLX_SUCCESS;
        ...
        {
                rv = GLX_ERR_PATTERN_COMPILATION;
                goto _err;
        }
        ...
        const int execution_flags)
{
        ...
        if (NULL == container->regex)
                return GLX_ERR_MISSING_COMPILED_PATTERN_BUFFER;
        if (NULL == container->groups)
                return GLX_ERR_MISSING_MATCH_GROUPS;
        ...
        {
                return GLX_ERR_REGEX_EXECUTION;
        }

        return GLX_SUCCESS;
}

enum GalxlibError match_str(
        RegexContainer *const container, 
        ...
        const int execution_flags)
{
        ...
        if (err_str == GLX_ERR_NULL_ARGUMENT)
                return GLX_ERR_NULL_ARGUMENT;
        else if (err_str == GLX_ERR_MEMORY_ALLOCATION)
                return GLX_ERR_MEMORY_ALLOCATION;
...
enum GalxlibError get_group_value(
...
enum GalxlibError get_group_value_nt(
    const RegexContainer *const container,
    const size_t group_index,
    char **const output,
    size_t *const output_length)
...
enum GalxlibError get_group_value_str(
    const RegexContainer *const container,
    const size_t group_index,
    String **const output)
{
        ...
        {
        case GLX_ERR_INVALID_ARGUMENT_DIMENTIONS:
                return GLX_ERR_INVALID_ARGUMENT_DIMENTIONS;
        case GLX_ERR_MEMORY_ALLOCATION:
                return GLX_ERR_MEMORY_ALLOCATION;
        case GLX_ERR_NULL_ARGUMENT:
                return GLX_ERR_NULL_ARGUMENT;
        }
