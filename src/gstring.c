...
static enum GalxlibError _new_char_array(size_t length, char **const output)
{
	if (output == NULL)
		return GLX_ERR_NULL_ARGUMENT;

	if (length == 0)
		return GLX_ERR_INVALID_ARGUMENT_DIMENTIONS;
...
static enum GalxlibError _extend(String *const str_to_extend, size_t const extend_count)
{
...
static enum GalxlibError _shrink(String *const str_to_shrink, size_t const shrink_count)
{
...
static enum GalxlibError _shift_one_right(String *const str)
{
	if (str == NULL)
		return GLX_ERR_NULL_ARGUMENT;

	if (str->str == NULL)
		return GLX_ERR_NULL_STR;
 ...
 */
static enum GalxlibError _shift_count_right(String *const str, size_t const count)
{
	if (str == NULL)
		return GLX_ERR_NULL_ARGUMENT;
...
static enum GalxlibError _index_of_nt(const char *const char_arr, size_t *const output)
{
 ...
 */
static enum GalxlibError _copy_chars(const char *const source, char *const dest, size_t const count)
{
...
static enum GalxlibError _duplicate_char_array(const char *const char_arr, size_t const length, char **const output)
{
	if (char_arr == NULL || output == NULL)
		return GLX_ERR_NULL_ARGUMENT;
 ...
 * - GLX_ERR_ZERO_LENGTH
 */
static enum GalxlibError _validate_nsl(const String *const str)
{
	if (str == NULL)
		return GLX_ERR_NULL_ARGUMENT;
 ...
 * - GLX_ERR_MEMORY_ALLOCATION
 */
static enum GalxlibError _split_str_pattern_to_empty(
...
enum GalxlibError new_string(const char *const char_arr, size_t length, String **const output)
{
	if (output == NULL)
		return GLX_ERR_NULL_ARGUMENT;
...
enum GalxlibError new_string_nt(const char *const char_arr, String **const output)
{
	if (output == NULL)
		return GLX_ERR_NULL_ARGUMENT;
...
enum GalxlibError free_string(String **str)
{
	if (NULL == str)
		return GLX_ERR_NULL_ARGUMENT;
	if (NULL == *str)
...
enum GalxlibError append_char(String *const str, const char c)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError append_char_array(String *const str_dest, const char *const source, const size_t source_length)
{
...
enum GalxlibError append_nt(String *const str_dest, const char *const source)
{
	int err_valid = _validate_nsl(str_dest);
	if (err_valid)
		return err_valid;
...
enum GalxlibError append_str(const String *const str_source, String *const str_dest)
{
...
enum GalxlibError prepend_char(String *const str, const char c)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError prepend_char_array(String *const str_dest, const char *const source, const size_t source_length)
{
	int err_valid = _validate_nsl(str_dest);
	if (err_valid)
		return err_valid;
...
enum GalxlibError prepend_nt(String *const str_dest, const char *const source)
{
	int err_valid = _validate_nsl(str_dest);
	if (err_valid)
		return err_valid;
...
enum GalxlibError prepend_str(const String *const source, String *const dest)
{
...
enum GalxlibError duplicate_str(const String *const source, String **const output)
{
	int err_valid = _validate_nsl(source);
	if (err_valid)
		return err_valid;
...
enum GalxlibError get_raw(const String *const source, char **const output)
{
	int err_valid = _validate_nsl(source);
	if (err_valid)
		return err_valid;
...
enum GalxlibError get_raw_nt(const String *const source, char **const output)
{
	int err_valid = _validate_nsl(source);
	if (err_valid)
		return err_valid;
...
enum GalxlibError filter_str(String *const str, int (*filter)(char c))
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError replace_char(String *const str, const char to_replace, const char replacement)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError remove_char(String *const str, const char to_remove)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError concat_str(String **const output, const size_t n_str, ...)
{
	/**
...
enum GalxlibError concat_str_da(String **const output, DynamicArray *const strings)
{
...
enum GalxlibError concat_str_da_c(
    String **const output,
...
enum GalxlibError trim(String *const str)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError split_str(const String *const str, const String *const pattern, DynamicArray **const output)
{
	int err_valid = _validate_nsl(str);
	if (err_valid)
		return err_valid;
...
enum GalxlibError includes_str(
    const String *const str,
...
enum GalxlibError starts_with_nt(
    const String *const str,
