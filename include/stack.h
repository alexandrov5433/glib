 ...
 */
GALXLIB_API Stack *newStack(int capacity);
 ...
 */
GALXLIB_API int isFullS(const Stack *stack);
 ...
 */
GALXLIB_API int pushS(Stack *stack, void *const ptr);
 ...
 */
GALXLIB_API void *popS(Stack *stack);
 ...
 * @returns The pointer, which was the topmost element. If the Stack is empty (isEmptyS function), returns NULL.
 */
GALXLIB_API void *peekS(const Stack *stack);
 ...
 */
GALXLIB_API int processS(const Stack *stack, void (*processor)(void *const ptr));
 ...
 */
GALXLIB_API DynamicStack *newDynamicStack();
 ...
 */
GALXLIB_API int isEmptyDS(const DynamicStack *stack);
 ...
 */
GALXLIB_API void freeDS(DynamicStack *stack);
 ...
 */
GALXLIB_API int pushDS(DynamicStack *stack, void *const ptr);
 ...
 */
GALXLIB_API void *popDS(DynamicStack *stack);
 ...
 */
GALXLIB_API void *peekDS(const DynamicStack *stack);
 ...
 */
GALXLIB_API int processDS(const DynamicStack *stack, void (*processor)(void *const ptr));
