 ...
 */
GLIB_API BinaryTree *newBinaryTree(const void *ptr, int (*comparator)(const void *a, const void *b));
 ...
 */
GLIB_API int freeBTAndData(BinaryTree *bt, void (*releaser)(const void *ptr));
 ...
 */
GLIB_API int addToBT(BinaryTree *bt, const void *ptr);
 ...
 */
GLIB_API void *findInBT(BinaryTree *bt, int searchAlg, int (*selector)(const void *ptr));
 ...
 */
GLIB_API void processBT(BinaryTree *bt, void (*processor)(const void *ptr));
